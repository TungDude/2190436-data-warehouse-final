    ...
    sheets {
      ...
      parameter_controls {
        date_time_picker {
          ...
          # changes. "Show community/crime attributes as of" reads as a
          # historical filter to a non-warehouse audience and matches the
          # actual behaviour (filters fact rows to the dim_location AND
